...
Initially Generated By:
    python -m utool --tf setup_repo --repo=dtool_ibeis --codedir=~/code --modname=dtool_ibeis --force-run_tests.py
"""
...
def run_tests():
    ...
    import sys
    ut.change_term_title('RUN dtool_ibeis TESTS')
