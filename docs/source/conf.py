...
Notes:
    ...
    cd ~/code/dtool_ibeis/docs
    sphinx-apidoc --private --separate -f -o ~/code/dtool_ibeis/docs/source/auto ~/code/dtool_ibeis/dtool_ibeis
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/dtool-ibeis/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: dtool_ibeis
            Set the Repository URL: https://github.com/Erotemic/dtool_ibeis

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/dtool-ibeis/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/dtool_ibeis/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/dtool-ibeis/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'dtool_ibeis')
...
# html_logo = '.static/dtool_ibeis.svg'
# html_favicon = '.static/dtool_ibeis.ico'
...
latex_documents = [
    (master_doc, 'dtool_ibeis.tex', 'dtool_ibeis Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'dtool_ibeis', 'dtool_ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dtool_ibeis', 'dtool_ibeis Documentation',
     author, 'dtool_ibeis', 'One line description of project.',
     'Miscellaneous'),
]
