...
Notes:
    ...
    rm -rf ~/code/dtool_ibeis/docs/source/auto
    cd ~/code/dtool_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/dtool_ibeis/docs/source/auto ~/code/dtool_ibeis/dtool_ibeis
...
man_pages = [
    (master_doc, 'dtool_ibeis', 'dtool_ibeis Documentation', [author], 1)
]
