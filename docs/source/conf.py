...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/dtool_ibeis/docs/source ~/code/dtool_ibeis/dtool_ibeis --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/dtool_ibeis/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/dtool_ibeis/versions/
"""
#
...
htmlhelp_basename = 'dtool_ibeisdoc'
